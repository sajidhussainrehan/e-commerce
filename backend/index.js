...
mongoose.connect("mongodb+srv://rehannetwork000:REHAN786cric4you@cluster0.ebnehgz.mongodb.net/e-commerce");
// api creation
app.get("/",(req,res)=>{
...
app.get('/pupularinwomen',async (req,res)=>{
